...
• "Put the concert on my calendar — April 5, 8pm to 11pm at Stadium"`,
  {
    ...
    calendar:     z.string().optional().describe('Calendar name to write to (e.g. "Family", "Eden\'s Schedule"). Resolves to calendar ID via gcal-config.json. Defaults to account\'s default_calendar_id.'),
